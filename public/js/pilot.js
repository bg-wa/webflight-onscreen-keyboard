...
(function (window, document, $, undefined) {
    ...
    var Pilot = function Pilot(cockpit) {
        ...
        var buttonHTML = jQuery.map(buttons, function (button) {
            return "<div class='button' id='" + button.id + "' data-ev='" + button.ev + "'><i class='fa fa-"+button.icon+"'  aria-hidden='true'></i> " + button.name + " (" + button.key + ")</div>"
        });
        ...
        $('#controls').append('<div id="ftrim" class="btn btn-primary"><i class="fa fa-balance-scale" aria-hidden="true"> Trim</i></div> ');
        $('#controls').append('<div id="calibratemagneto" class="btn btn-info"><i class="fa fa-magnet" aria-hidden="true"> Calibrate</i></div> ');
    ...
    Pilot.prototype.listen = function listen() {
        ...
        $('.button').click(function () {
            ...
            pilot.keyDown({
                keyCode: button.data().ev, preventDefault: function () {
                }
            });
        });
